...
def createBlocks(a1, c1, c2, bull):
    ...
    for i in range(6):
        ...
        if (i < 5):
            ...
            a2_1 = a1 + (bull[i + 7]/2 )
            if (i==0):
                raio0 = lerp(a1 + bull[12]/2, a1 + bull[13]/2, 0, pi/2, pi/12)
                a2_2 = raio0#a1 + (bull[12] );
                raio1 = lerp(a1 + bull[12]/2, a1 + bull[13]/2, 0, pi/2, pi/2-pi/12)
                a2_3 = raio1#a1 + (bull[13] )
                raio0 = lerp(a1 - bull[12]/2, a1 - bull[13]/2, 0, pi/2, pi/12)
                a1_2 = raio0 #a1 #- (bull[i + 12] / 2);
                raio1 = lerp(a1 - bull[12]/2, a1 - bull[13]/2, 0, pi/2, pi/2-pi/12)
                a1_3 = raio1 #a1 #- (bull[i + 13] / 2)
            elif (i==1):
                raio0 = lerp(a1 + bull[12]/2, a1 + bull[13]/2, 0, pi/2, pi/2-pi/12)
                a2_2 = raio0 #a1 + (bull[13] );
                raio1 = lerp(a1 + bull[13]/2, a1 + bull[14]/2, 0, pi/2, 2*pi/3 - (pi/2-pi/12))
                ...
                raio0 = lerp(a1 + bull[13]/2, a1 + bull[14]/2, 0, pi/2, 2*pi/3 - (pi/2-pi/12))
                a2_2 = raio0 #a1 + (bull[13] );
                raio1 = lerp(a1 + bull[14]/2, a1 + bull[15]/2, 0, pi/2, pi/12)
                a2_3 = raio1 #a1 + (bull[14] )
                ...
                raio0 = lerp(a1 + bull[14]/2, a1 + bull[15]/2, 0, pi/2, pi/12)
                a2_2 = raio0 #a1 + (bull[14] );
                raio1 = lerp(a1 + bull[14]/2, a1 + bull[15]/2, 0, pi/2, 4*pi/3 - (pi - pi/12) )
                ...
                raio0 = lerp(a1 + bull[14]/2, a1 + bull[15]/2, 0, pi/2, 4*pi/3 - (pi - pi/12) )
                a2_2 = raio0 #a1 + (bull[15] );
                raio1 = lerp(a1 + bull[15]/2, a1 + bull[16]/2, 0, pi/2, 5*pi/3 - (3*pi/2 - pi/12) )
...
#            a2_3 = a1 + (bull[i + 13] )
            ...
            raio0 = lerp(a1 + bull[15]/2, a1 + bull[16]/2, 0, pi/2, 5*pi/3 - (3*pi/2 - pi/12) )
            a2_2 = raio0 #a1 + (bull[15] )
            raio1 = lerp(a1 + bull[12]/2, a1 + bull[13]/2, 0, pi/2, pi/12)
            ...
            raio0 = lerp(a1 - bull[15]/2, a1 - bull[16]/2, 0, pi/2, 5*pi/3 - (3*pi/2 - pi/12) )            
            a1_2 = raio0 #a1 #- (bull[11 + (i + 6 - 5)] / 2)
            raio1 = lerp(a1 - bull[12]/2, a1 - bull[13]/2, 0, pi/2, pi/12)
            a1_3 = raio1 #a1 #- (bull[6 + (i + 6 - 5)] / 2)
